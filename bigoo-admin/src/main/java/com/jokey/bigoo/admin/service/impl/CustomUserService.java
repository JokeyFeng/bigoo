...
public class CustomUserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        BigooUserDetail userDetail = new BigooUserDetail(user.getUsername(), user.getPassword(), grantedAuthorities);
        ...
        userDetail.setLoginTime(DateUtil.getDateFormat(new Date(), DateUtil.YYYY_MM_DD_HH_MM_SS));
